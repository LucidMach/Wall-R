...
// fill: `hsl(${100 - bot.fillPercent}, 75%, 45%, 1)`,

const Bin: React.FC<Props> = ({ bot, capacity }) => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <h2 className="text-center absolute top-2/3 text-white font-normal -translate-y-4">
        Fill Percent
      </h2>
      <h1 className="text-center text-7xl absolute top-1/2 text-white font-semibold">
        {bot.fillPercent}
      </h1>
      <br />
      {/* {JSON.stringify(bot)} */}
